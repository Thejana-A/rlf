    ...
    <head>
        ...
        <?php
            ...
            if(isset($_POST["search"])){
                ...
                $sql = "SELECT quotation_id, first_name, last_name, request_date, issue_date, valid_till, manager_approval FROM costume_quotation INNER JOIN customer ON costume_quotation.customer_id = customer.customer_id AND merchandiser_id = '$merchandiserID';";
                $search_output = "";
                $output = "";
