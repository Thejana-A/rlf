                    ...
                    if(mysqli_num_rows($search_result) > 0){
                        while($search_row = mysqli_fetch_array($search_result)){
                            ...
                            if($search_row["category"] == "costume quotation"){
                                $search_output.= "<span class='notification-message'><a style='text-decoration:none;' href='view_costume_quotation.php?quotation_id=".explode(" ",$search_row["message"])[(count(explode(" ",$search_row["message"])))-1]."'>".$search_row["message"]."</a></span>";  
                    ...
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_array($result)){
                            ...
                            if($row["category"] == "costume quotation"){
                                $output.= "<span class='notification-message'><a style='text-decoration:none;' href='view_costume_quotation.php?quotation_id=".explode(" ",$row["message"])[(count(explode(" ",$row["message"])))-1]."'>".$row["message"]."</a></span>";  
        ...
        <div id="page-body">
            ...
            <div id="page-content">
                <div id="breadcrumb">
                    ...
                    <a href="home.php">Merchandiser</a> > Notifications
                </div>
