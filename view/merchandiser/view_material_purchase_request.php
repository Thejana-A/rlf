                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row-data">
                                <table width="60%">
                                    <tr>
                                        <td>
                                            <input type="radio" name="manager_approval" class="input-radio" id="" disabled /> Approved
                                        </td>
                                        <td>
                                            <input type="radio" name="manager_approval" class="input-radio" id="" disabled /> Rejected
                                        </td>
                                    </tr>
                                </table>
                            </div>
