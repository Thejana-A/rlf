...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/fashion_designer/box_modal.css" />
        <?php 
                ...
                <div id="page-content">
                    ...
                    <div id="form-box-ultra-small">
                        <form method="post" name="costumeDesignForm" action="../RouteHandler.php" enctype="multipart/form-data">
                            ...
                            <input type="text" hidden="true" name="fashion_designer_id" id="fashion_designer_id" value="<?php echo $row["fashion_designer_id"] ?>" readonly />
