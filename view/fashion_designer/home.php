                ...
                <div id="list-box-ultra-small" style="width:95%;">
                    ...
                    <div class="item-heading-row">
                        ...
                        <?php 
                            ...
                            $sql_costume = "SELECT DISTINCT SUBSTRING_INDEX(name,'-',LENGTH(name)-LENGTH(REPLACE(name,'-',''))) as costume_name, design_approval_date FROM costume_design WHERE design_approval_date BETWEEN '$lastSunday' AND '$nextSunday' AND fashion_designer_id = ".$_SESSION['employee_id'].";";
