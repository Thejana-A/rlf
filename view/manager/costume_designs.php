        ...
        <?php
            ...
            if(isset($_POST["search"])){
                ...
                $search_sql_costume = "(SELECT c.design_id, c.name, c.fashion_designer_id, c.merchandiser_id, c.front_view, e1.first_name merchandiser_first_name, e1.last_name merchandiser_last_name,  e2.first_name fd_first_name, e2.last_name fd_last_name 
                    ...
                    WHERE (`name` LIKE '%$searchbar%' OR e1.first_name LIKE '%$searchbar%' OR e1.last_name LIKE '%$searchbar%' OR e2.first_name LIKE '%$searchbar%' OR e2.last_name LIKE '%$searchbar%') AND customized_design_approval = 'approve')
                    UNION
                    ...
                    WHERE (`name` LIKE '%$searchbar%' OR e2.first_name LIKE '%$searchbar%' OR e2.last_name LIKE '%$searchbar%') AND customized_design_approval = 'approve')
                    UNION
                    ...
                    WHERE (`name` LIKE '%$searchbar%' OR e1.first_name LIKE '%$searchbar%' OR e1.last_name LIKE '%$searchbar%') AND customized_design_approval = 'approve')
                    UNION
                    ...
                    WHERE `name` LIKE '%$searchbar%' AND customized_design_approval = 'approve');";
                ...
                for($i = 0;$i<count($costume_name);$i++){
                    ...
                    if ($result_costume_row->num_rows > 0) {
                        while ($costume_row = $result_costume_row->fetch_assoc()) { 
                            ...
                            $output.= "<span style='width:15%;'>".$costume_name[$i]."</span><span style='width:20%;'>".$costume_row["merchandiser_first_name"]." ".$costume_row["merchandiser_last_name"]."</span><span style='width:20%;'>".$costume_row["fd_first_name"]." ".$costume_row["fd_last_name"]."</span>";
