                ...
                <div id="list-box">
                    ...
                    <div class="item-list">
                        ...
                        <?php 
                            ...
                            $sql2 = "SELECT design_id, merchandiser_id, first_name, last_name FROM costume_design INNER JOIN employee WHERE employee_id = merchandiser_id AND customized_design_approval = 'approve'
                            UNION 
