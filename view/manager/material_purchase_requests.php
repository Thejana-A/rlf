    ...
    <head>
        ...
        <?php 
            ...
            if(isset($_POST["search"])){
                ...
                $sql = "SELECT order_id, first_name, last_name, expected_delivery_date, manager_approval, dispatch_date, raw_material_quotation.quotation_id FROM raw_material_order, supplier, raw_material_quotation WHERE raw_material_order.quotation_id = raw_material_quotation.quotation_id AND raw_material_quotation.supplier_id = supplier.supplier_id;";
                $search_output = "";
                $output = "";
