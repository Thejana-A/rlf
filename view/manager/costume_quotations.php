        ...
        <?php
            ...
            if(isset($_POST["search"])){
                ...
                /*if(($minIssueDate == "")&&($maxIssueDate == "")&&($minValidTill == "")&&($maxValidTill == "")){
                    $search_sql = "SELECT quotation_id, first_name, last_name, request_date, issue_date, valid_till, manager_approval FROM costume_quotation INNER JOIN customer ON costume_quotation.customer_id = customer.customer_id AND (quotation_id LIKE '%$searchbar%' OR  first_name LIKE '%$searchbar%' OR last_name LIKE '%$searchbar%');";
                ...
                if(($minIssueDate=="")&&($maxIssueDate=="")&&($minValidTill=="")&&($maxValidTill=="")&&($minRequestDate=="")&&($maxRequestDate=="")){
                    ...
                    $search_sql = "SELECT quotation_id, first_name, last_name, request_date, issue_date, valid_till, manager_approval FROM costume_quotation INNER JOIN customer ON costume_quotation.customer_id = customer.customer_id AND (quotation_id LIKE '%$searchbar%' OR  first_name LIKE '%$searchbar%' OR last_name LIKE '%$searchbar%') AND (request_date >= '$minRequestDate' AND request_date <= '$maxRequestDate');";
                }else{
                ...
                $sql = "SELECT quotation_id, first_name, last_name, request_date, issue_date, valid_till, manager_approval FROM costume_quotation INNER JOIN customer on costume_quotation.customer_id = customer.customer_id;";
                $search_output = "";
                $output = "";
        ...
        <div id="page-body">
            ...
            <div id="page-content">
                <div id="breadcrumb">
                    ...
                    <a href="home.php">Manager</a> > Costume designs quotations
                </div>
                <div class="link-row">
                ...
                <div id="list-box">
                    ...
                    <div class="item-list">
                        <div class="item-heading-row">
                            ...
                            <b style="width:15%;">Customer name</b>
