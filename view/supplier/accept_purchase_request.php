    ...
    <div id="page-body">
        ...
        <div id="page-content">
            <div id="breadcrumb">
                ...
                <a href="view_purchase_requests.php">Purchase requests </a>> View
            </div>
            ...
            <div id="form-box">
                <form method="post" name="materialOrderForm" action="../RouteHandler.php">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-data">
                            <input type="text" name="quotation_id" id="" value="<?php echo $row["quotation_id"] ?>"
                                readonly />
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-row-data">
                            <input type="text" name="supplier_id" id="" value="<?php echo $row["supplier_id"] ?>"
                                readonly />
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-row-data">
                            <input type="text" name="valid_till" id="" value="<?php echo $row["valid_till"] ?>"
                                readonly />
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-row-data">
                            <input type="text" name="expected_delivery_date" id=""
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row-data">
                            <input type="text" name="dispatch_date" id="" value="<?php echo $row["dispatch_date"] ?>"
                                readonly />
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-row-data">
                            <input type="text" name="payment_date" id="" value="<?php echo $row["payment_date"] ?>"
                                readonly />
                        </div>
                    </div>
                    <br>
