            ...
            if ($stmt = mysqli_prepare($conn, $sql)) {
                ...
                if($affectedRows == -1){
                    ...
                    if($_POST["requester_role"] == "supplier"){
                        date_default_timezone_set("Asia/Calcutta");
                        $notification_message = "Material request was updated - ID ".$this->materialID;
        ...
        public function delete(){
            ...
            if ($stmt = mysqli_prepare($conn, $sql)) {
                ...
                if($affectedRows == -1){
                    ...
                    $sql_delete_notification = "DELETE FROM notification WHERE (`category` = 'raw material' OR `category` = 'tender request') AND message LIKE '%$this->materialID'";
